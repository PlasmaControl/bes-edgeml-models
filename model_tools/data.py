...
class Data(object):
    ...
    def __init__(self,
        ...
        self.n_training_batches = self.training_data[2].shape[0] // self.training_batch_size
    ...
    def _make_generator(self, signals_in, labels_in, sample_indices_in):
        ...
        def generator():
            ...
            while i < sample_indices_in.shape[0]:
                ...
                assert((i_t0 + signal_window_size + label_look_ahead - 1) < labels_in.shape[0])
                signal_window = signals_in[i_t0:i_t0 + signal_window_size, ...]
                signal_window = tf.reshape(signal_window, [signal_window_size, 8, 8, 1])
                label = labels_in[i_t0 + signal_window_size + label_look_ahead - 1]
