"""
Data class to package BES data for training using wavelet transforms on the 
    ...
    def _preprocess_data(
        ...
        for elm_index in elm_indices:
            ...
            if len(_labels) < 2000:
                ...
                # calculate gradients
                _dsignals_y, _dsignals_x = np.gradient(_signals, axis=(1, 2))
                _dsignals_t = _signals[-1, ...] - _signals[0, ...]
                _signals = np.array([_dsignals_t, _dsignals_x, _dsignals_y])
