...
def get_dataloader(args: argparse.Namespace, logger: logging.Logger, use_saved=True):
    ...
    try:
        ...
        # import data
        train_dataset = src.data.ELMDataset(args, *train_data, logger=logger, transform=None)
