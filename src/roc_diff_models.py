...
if __name__ == "__main__":
    ...
    # # lr
    df_lr_0 = pd.read_csv(os.path.join(path_0, "roc_details_lr_manual_lookahead_0.csv"))
    df_lr_50 = pd.read_csv(os.path.join(path_50, "roc_details_lr_manual_lookahead_50.csv"))
    df_lr_100 = pd.read_csv(os.path.join(path_100, "roc_details_lr_manual_lookahead_100.csv"))
    df_lr_200 = pd.read_csv(os.path.join(path_200, "roc_details_lr_manual_lookahead_200.csv"))
    # df_lr_400 = pd.read_csv(
    #     os.path.join(path_400, "roc_details_lr_lookahead_400.csv")
    # )

    # # rf
    df_rf_0 = pd.read_csv(os.path.join(path_0, "roc_details_rf_manual_lookahead_0.csv"))
    ...
    # # xgb
    df_xgb_0 = pd.read_csv(os.path.join(path_0, "roc_details_xgb_manual_lookahead_0.csv"))
    ...
    # cnn model
    df_cnn_0 = pd.read_csv(os.path.join(path_0, "cnn_roc_details_micro_unbalanced_lookahead_0_wavelet.csv"))
    # df_cnn_10 = pd.read_csv(
    #     os.path.join(
    #         path_10, "cnn_roc_details_micro_unbalanced_lookahead_10.csv"
    #     )
    # )
    df_cnn_50 = pd.read_csv(os.path.join(path_50, "cnn_roc_details_micro_unbalanced_lookahead_50_wavelet.csv"))
    df_cnn_100 = pd.read_csv(os.path.join(path_100, "cnn_roc_details_micro_unbalanced_lookahead_100_wavelet.csv", ))
    df_cnn_150 = pd.read_csv(os.path.join(path_150, "cnn_roc_details_micro_unbalanced_lookahead_150_wavelet.csv", ))
    df_cnn_200 = pd.read_csv(os.path.join(path_200, "cnn_roc_details_micro_unbalanced_lookahead_200_wavelet.csv", ))

    # # plotting lr
    fig, ax = plt.subplots(figsize=(6, 4), dpi=100)
    ax.plot(df_lr_0["fpr"], df_lr_0["tpr"], "-", lw=2, # c="#636EFA",
            label="lookahead: 0", )
    ax.plot(df_lr_50["fpr"], df_lr_50["tpr"], "-", lw=2, # c="#EF553B",
            label="lookahead: 50", )
    ax.plot(df_lr_100["fpr"], df_lr_100["tpr"], "-", lw=2, # c="#00CC96",
            label="lookahead: 100", )
    ax.plot(df_lr_200["fpr"], df_lr_200["tpr"], "-", lw=2, # c="#00CC96",
            label="lookahead: 200", )
    # ax.plot(
    #     df_lr_400["fpr"],
    #     df_lr_400["tpr"],
    ...
    # plotting cnn
    fig, ax = plt.subplots(figsize=(6, 4), dpi=100)
    ax.plot(df_cnn_0["fpr"], df_cnn_0["tpr"], "-", lw=2, # c="#636EFA",
            label="lookahead: 0", )
    # ax.plot(
    #     df_cnn_10["fpr"],
    #     df_cnn_10["tpr"],
    ...
    #     label="lookahead: 10",
    # )
    ax.plot(df_cnn_50["fpr"], df_cnn_50["tpr"], "-", lw=2, # c="#EF553B",
            label="lookahead: 50", )
    ax.plot(df_cnn_100["fpr"], df_cnn_100["tpr"], "-", lw=2, # c="#00CC96",
            label="lookahead: 100", )
    # ax.plot(
    #     df_cnn_150["fpr"],
    #     df_cnn_150["tpr"],
    ...
    #     label="lookahead: 150",
    # )
    ax.plot(df_cnn_200["fpr"], df_cnn_200["tpr"], "-", lw=2, # c="#00CC96",
            label="lookahead: 200", )
    ax.plot([0, 1], [0, 1], c="gray", lw=2)
    ...
    ax.plot(df_lr_0["fpr"], df_lr_0["tpr"], "-", lw=2, # c="#636EFA",
            label="lr", )
    ax.plot(df_rf_0["fpr"], df_rf_0["tpr"], "-", lw=2, # c="#EF553B",
            label="rf", )
    ax.plot(df_xgb_0["fpr"], df_xgb_0["tpr"], "-", lw=2, # c="#00CC96",
            label="xgb", )
    # ax.plot(
    #     df_cnn_150["fpr"],
    #     df_cnn_150["tpr"],
    ...
    #     label="lookahead: 150",
    # )
    ax.plot(df_cnn_0["fpr"], df_cnn_0["tpr"], "-", lw=2, # c="#00CC96",
            label="cnn", )
    ax.plot([0, 1], [0, 1], c="gray", lw=2)
    ax.legend(fontsize=10, frameon=False)
    sns.despine(offset=10, trim=False)
