...
if __name__ == "__main__":
    ...
    input_path = input("Enter the corresponding base directory path without trailing slash:")
    if file_ext == ".pkl" and input_path == pkl_path[:-2]:
        ...
        raise ValueError("Path and the file extension are not compatible with each other.")
