...
class VAEfcls32Model(nn.Module):
    ...
    def __init__(self, args: argparse.Namespace, num_filters: int = 256,
        ...
        self.encoder = nn.Sequential(OrderedDict(
                [('flatten', nn.Flatten()), ('fc0', nn.Linear(in_features=self.in_size, out_features=num_filters)),
        ...
        self.decoder = nn.Sequential(OrderedDict(
                [('fc1_decoder', nn.Linear(in_features=self.latent_dim, out_features=fc_units[1])),
                 ...
                 ('relu3_decoder', nn.LeakyReLU(negative_slope=negative_slope)), ('tconv_decoder',
                                                                                  nn.Linear(in_features=num_filters,
                                                                                            out_features=self.args.signal_window_size * 8 * 8)),
