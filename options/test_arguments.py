...
class TestArguments(BaseArguments):
    ...
    def create_parser(self, parser):
        ...
        # basic parameters
        parser.add_argument("--output_dir", type=str, default="outputs", help="path to the inference outputs.", )
        # test parameters
        parser.add_argument("--threshold", type=float, default=0.5,
                help="threshold to create binary predictions from probability.", )
        parser.add_argument("--test_data_info", action="store_false", default=False,
                help="if true, show the information about the test data.", )
        parser.add_argument("--plot_num", type=int, default=12,
