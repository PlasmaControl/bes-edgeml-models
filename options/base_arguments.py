...
class BaseArguments:
    ...
    def create_parser(self, parser: argparse.ArgumentParser):
        ...
        parser.add_argument(
            ...
            type=str,
            default="cpu",
            help="device to be used for training and testing. [cpu | cuda], Default: cpu",
        )
        parser.add_argument(
            "--k_fold",
            action="store_false",
        ...
        parser.add_argument(
            ...
            type=int,
            default=-1,
            help="total number of elm events to be used. Use -1 to use all of them. Default: -1",
        )
        # dataset parameters
        parser.add_argument(
            "--batch_size",
        ...
        parser.add_argument(
            ...
            type=float,
            default=0.2,
            help="size of the validation dataset. Default: 0.2",
        )
        parser.add_argument(
            "--fraction_test",
            type=float,
        ...
        parser.add_argument(
            ...
            "when '--add_noise=True'. Default: 0.01",
        )
