...
class BaseArguments:
    ...
    def create_parser(self, parser: argparse.ArgumentParser):
        ...
        parser.add_argument("--add_tensorboard",
                            action="store_true",
                            default=False,
        ...
        parser.add_argument("--batch_size", type=int, default=64, help="batch size for model training and testing.", )
        ...
        parser.add_argument("--signal_window_size",
                            ...
                            help="number of time data points to use for the input. "
                                 ...
                                 "[8 | 16].", )
        parser.add_argument("--label_look_ahead",
                            type=int,
                            default=0,
        ...
        parser.add_argument("--truncate_inputs",
                            action="store_true",
                            default=False,
        ...
        parser.add_argument("--truncate_buffer",
                            type=int,
                            default=75,
        ...
        parser.add_argument("--sigma",
                            ...
                            help="standard deviation of the Gaussian noise. Must be passed "
                                 "when `gaussian_noise` is passed as `data_preproc`.", )
        parser.add_argument("--shuffle_sample_indices",
                            action="store_true",
                            default=False,
        ...
        parser.add_argument("--mf_time_slice_interval",
                            type=int,
                            default=1,
        ...
        parser.add_argument("--dwt_wavelet",
                            type=str,
                            default="db4",
                            help="Wavelet string for DWTFeatureModel: default `db4`", )
        parser.add_argument("--dwt_level",
                            type=int,
                            default=3,
